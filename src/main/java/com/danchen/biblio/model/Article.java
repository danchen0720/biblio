...
public class Article implements java.io.Serializable {
	...
	private int state;
	private StringClobType content;
	...
	public Article(User user, Date time, Integer parent, int state,
			StringClobType content, String title, Set tags) {
		this.user = user;
		this.time = time;
		this.parent = parent;
		this.state = state;
	...
	public StringClobType getContent() {
		return this.content;
	}

	public void setContent(StringClobType content) {
		this.content = content;
	}
